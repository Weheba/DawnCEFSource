...
if not mode.endswith('symbols'):
  ...
  # Identify Dawn's patched native-codec distribution for downstream JCEF
  # builds. The marker is intentionally copied into every non-symbol archive.
  copy_file(
      os.path.join(cef_dir, 'dawn', 'dawn-codec-build.properties'), output_dir,
      options.quiet)
